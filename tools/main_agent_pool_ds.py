...
from .main_item_deepseek import DifyAgentStreamClient

class Main_Item_ChatBot_DeepSeek_Pool:
    ...
    def _create_instance(self):
        ...
        with self._lock:
            ...
            try:
                instance = DifyAgentStreamClient()
...
def get_global_pool(pool_size=20):
    ...
    if _main_item_pool is None:
        with _pool_lock:
            if _main_item_pool is None:
                _main_item_pool = Main_Item_ChatBot_DeepSeek_Pool(pool_size)
